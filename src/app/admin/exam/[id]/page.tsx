...
export default async function ShowExam(props: any) {
  const examId = parseInt(props.params.id);
  ...
  return (
    <div>
      ...
      <div className="px-4 py-3 rounded bg-slate-200 flex flex-wrap justify-between items-center mb-3">
